	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.btn).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				String oldFilePath = Environment.getExternalStorageDirectory() + File.separator + "EzonSport_2.1.8.apk";
				String patchPath = Environment.getExternalStorageDirectory() + File.separator + "patch_2.1.8_2.2.0.apk";
				String newFilePath = Environment.getExternalStorageDirectory() + File.separator + "EzonSport_2.2.0.apk";
